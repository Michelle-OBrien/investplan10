    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute left-0 top-full mt-2 w-48 max-w-[calc(100vw-1rem)] bg-card border border-card-border rounded-lg shadow-lg z-50 py-2" style={{ minWidth: "180px" }}>
            {menuItems.map((item) => (
              <div key={item.href}>
                {item.onClick ? (
                  <button
