      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-card border border-card-border rounded-2xl p-6">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl text-sm font-medium border border-card-border text-foreground hover:border-foreground/30 transition cursor-pointer flex items-center justify-center gap-2"
          >
